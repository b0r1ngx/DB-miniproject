...
(так же там нужно указать действующий username:password какого-либо пользователя от установленной локально PostrgreSQL)
...
17. /tag/{id}  
    ...
    - DELETE	|Удалить тег-
Более подробную документацию можно увидеть в Swagger UI
    - localhost:5002/doc
...
также постарались сделать удобный вывод из таблиц.
...
а также свойствами например такими как - поддержка соединения внутри пула соединений для быстрого повторного использования и др.

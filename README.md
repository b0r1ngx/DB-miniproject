...
5. /user/{id}/album/{id}  
   ...
   + GET		|Получить информацию об альбоме и все фото альбома-  
   + PUT		|Изменить информацию об альбоме-
...
15. /theme/{id}  
    * GET		|Получить информацию о теме и все фото-
...
17. /tag/{id}  
    - GET		|Получить информацию о теге и все фото-
